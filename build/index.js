...
var Button = React__default.forwardRef(function (_a, ref) {
    ...
    return (jsxRuntime.jsxs("button", __assign({ style: style, disabled: disabled, type: htmlType, className: buttonClassName, onClick: onClick, ref: ref }, restProps, { children: [loading ? jsxRuntime.jsx(IconLoading, { className: "loading-icon" }, void 0) : null,
